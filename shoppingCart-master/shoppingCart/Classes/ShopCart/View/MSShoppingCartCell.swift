...
protocol MSShoppingCartCellDelegate: NSObjectProtocol {
...
class MSShoppingCartCell: UITableViewCell {
    ...
    /// 代理属性
    weak var delegate: MSShoppingCartCellDelegate?
    ...
    */
    ...
    // 老价格标签
    private lazy var oldPriceLabel: MSOldPriceLabel = {
        let oldPriceLabel = MSOldPriceLabel()
